...
public class netlogon {
    ...
    public static class netr_Credential extends NdrObject {
        ...
        public void encode(NdrBuffer _dst) throws NdrException {
            ...
            _dst.advance(1 * _datas);

            _dst = _dst.derive(_datai);
            for (int _i = 0; _i < _datas; _i++) {
    ...
    public static class netr_ServerReqChallenge extends DcerpcMessage {
        ...
        public netr_Credential credentials;

        public netr_ServerReqChallenge(String server_name, String computer_name, netr_Credential credentials) {
        ...
        public void encode_in(NdrBuffer _dst) throws NdrException {
            ...
            credentials.encode(_dst);
        }
        public void decode_out(NdrBuffer _src) throws NdrException {
            credentials.decode(_src);
            retval = (int)_src.dec_ndr_long();
        }
    }
    ...
    public static class netr_ServerAuthenticate extends DcerpcMessage {
        ...
        public int secure_channel_type;
        public String computer_name;
        public netr_Credential credentials;

        public netr_ServerAuthenticate(String server_name,
                    String account_name,
                    int secure_channel_type,
                    String computer_name,
                    netr_Credential credentials) {
            this.server_name = server_name;
        ...
        public void encode_in(NdrBuffer _dst) throws NdrException {
            ...
            _dst.enc_ndr_string(account_name);
            _dst.enc_ndr_short(secure_channel_type);
            _dst.enc_ndr_string(computer_name);
            credentials.encode(_dst);
        }
        public void decode_out(NdrBuffer _src) throws NdrException {
    ...
    public static class netr_ServerAuthenticate2 extends DcerpcMessage {
        ...
        public netr_ServerAuthenticate2(String server_name,
                    String account_name,
                    int secure_channel_type,
                    String computer_name,
                    netr_Credential credentials,
        ...
        public void encode_in(NdrBuffer _dst) throws NdrException {
            ...
            _dst.enc_ndr_string(computer_name);
            credentials.encode(_dst);
            _dst.enc_ndr_long(negotiate_flags);
        }
        public void decode_out(NdrBuffer _src) throws NdrException {
            credentials.decode(_src);
            negotiate_flags = (int)_src.dec_ndr_long();
            retval = (int)_src.dec_ndr_long();
        }
    }
    ...
    public static class netr_ServerAuthenticate3 extends DcerpcMessage {
        ...
        public netr_ServerAuthenticate3(String server_name,
                    String account_name,
                    int secure_channel_type,
                    String computer_name,
                    netr_Credential credentials,
