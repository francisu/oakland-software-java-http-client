...
public final class NtlmPasswordAuthentication implements Principal, Serializable {
    ...
    private static NtlmProvider _ntlmProvider = new NtlmProviderImpl();
    ...
    public static void setNtlmProvider(NtlmProvider ntlmProvider)
    {
	_ntlmProvider = ntlmProvider;
    }
 ...
 */
    public byte[] getAnsiHash( byte[] challenge ) {
        ...
        return _ntlmProvider.getAnsiHash(LM_COMPATIBILITY, domain, username, password, challenge, clientChallenge);
    }
 ...
 */
    public byte[] getUnicodeHash( byte[] challenge ) {
        ...
        return _ntlmProvider.getUnicodeHash(LM_COMPATIBILITY, domain, username, password, challenge, clientChallenge);
    }
