...
public class LogStream extends PrintStream {
    ...
    private static final Log _log = LogFactory
	    .getLog(LogStream.class.getName());
    ...
    protected static void setLogCommonsLevel() {
	// Set the level using the log4j levels
    ...
    /**
     * This must be called before <tt>getInstance</tt> is called or it will
     * have no effect.
     */
