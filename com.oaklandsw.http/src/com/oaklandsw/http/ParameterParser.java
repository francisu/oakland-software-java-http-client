...
public class ParameterParser {
     ...
     * characters.
     *
     * @param chars1 the array of characters that contains a sequence of 
     * name/value pairs
     * 
     * @return a list of {@link NameValuePair}s
     */
    public List parse(final char[] chars1, char separator) {

        if (chars1 == null) {
            return new ArrayList();
        }
        return parse(chars1, 0, chars1.length, separator);
    }
     ...
     * @return a list of {@link NameValuePair}s
     */
    public List parse(final char[] chars1, int offset, int length, char separator) {
        ...
        while (hasChar()) {
            ...
            paramValue = null;
            if (hasChar() && (chars1[pos] == '=')) {
                pos++; // skip '='
                paramValue = parseQuotedToken(new char[] {separator});
            }
            if (hasChar() && (chars1[pos] == separator)) {
                pos++; // skip separator
            }
