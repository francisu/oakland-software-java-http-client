...
public class RFC2109Spec extends CookieSpecBase
{
     ...
     *            The cookie version
     */
    private void formatParam(final StringBuffer buffer,
     ...
     *            The version to use.
     */
    private void formatCookieAsVer(final StringBuffer buffer,
                                   final Cookie cookie,
                                   int version)
    {
    ...
    public String formatCookie(Cookie cookie)
    {
        ...
        formatParam(buffer, new NameValuePair("$Version", Integer
    ...
    /**
     * Create a RFC 2109 compliant <tt>"Cookie"</tt> header value containing
     * all {@link Cookie}s in <i>cookies</i> suitable for sending in a
     * <tt>"Cookie"
     * </tt> header
     * 
     * @param cookies
