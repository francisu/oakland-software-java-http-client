...
public class NetscapeDraftSpec extends CookieSpecBase
{
                          ...
                          final String header) throws MalformedCookieException
    {
        ...
        Cookie cookie = new Cookie(host, headerelement.getName(), headerelement
                .getValue(), defaultPath, null, false);
        ...
        throws MalformedCookieException
    {
        ...
        if (paramName.equals("expires"))
        {
            ...
            try
            {
                DateFormat expiryFormat = new SimpleDateFormat("EEE, dd-MMM-yyyy HH:mm:ss z",
                                                               Locale.US);
