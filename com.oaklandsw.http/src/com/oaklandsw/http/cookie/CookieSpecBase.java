...
public class CookieSpecBase implements CookieSpec
{
    ...
    public CookieSpecBase()
    {
        ...
        datepatterns.addAll(Arrays.asList(new String[] {
            DateUtil.PATTERN_RFC1123, DateUtil.PATTERN_RFC1036,
            DateUtil.PATTERN_ASCTIME, "EEE, dd-MMM-yyyy HH:mm:ss z",
     ...
     * <PRE>
     * 
     * set-cookie = "Set-Cookie:" cookies cookies = 1#cookie cookie = NAME "="
     * VALUE * (";" cookie-av) NAME = attr VALUE = value cookie-av = "Comment"
     * "=" value | "Domain" "=" value | "Max-Age" "=" value | "Path" "=" value |
     * "Secure" | "Version" "=" 1*DIGIT
     * 
     * </PRE>
     * 
     * @param host
     *            the host from which the <tt>Set-Cookie</tt> value was
     *            received
     * @param port
     *            the port from which the <tt>Set-Cookie</tt> value was
     *            received
     * @param path
     *            the path from which the <tt>Set-Cookie</tt> value was
     *            received
     * @param secure
     *            <tt>true</tt> when the <tt>Set-Cookie</tt> value was
                          ...
                          final String header) throws MalformedCookieException
    {
        ...
        if (isNetscapeCookie)
        {
            headerElements = new HeaderElement[] { new HeaderElement(header
                    .toCharArray()) };
        }
        else
        {
        ...
        throws MalformedCookieException
    {
        ...
        else if (paramName.equals("expires"))
        {
            ...
            try
            {
                cookie.setExpiryDate(DateUtil.parseDate(paramValue,
                                                        this.datepatterns));
            }
    ...
    public void setValidDateFormats(final Collection datepatterns1)
    {
        this.datepatterns = datepatterns1;
    }
                         ...
                         final Cookie cookie)
    {
        ...
        (cookie.getExpiryDate() == null || cookie.getExpiryDate()
                .after(new Date()))
    ...
    /**
     * Create a <tt>"Cookie"</tt> header value containing all {@link Cookie}s
     * in <i>cookies</i> suitable for sending in a <tt>"Cookie"</tt> header
     * 
     * @param cookies
