...
package com.oaklandsw.util.log;
...
public class Log4JLogger implements Log, Serializable {
	...
	static {
		...
		// Releases of log4j1.2 >= 1.2.12 have Level.TRACE available, earlier
	...
	/**
	 * Logs a message with <code>org.apache.log4j.Level.TRACE</code>. When using
	 * a log4j version that does not support the <code>TRACE</code> level, the
	 * message will be logged at the <code>DEBUG</code> level.
	 * 
	 * @param message
	 *            to log
	 ...
	 * Level. When using a log4j version that does not support the TRACE level,
	 * this call will report whether <code>DEBUG</code> is enabled or not.
	 */
