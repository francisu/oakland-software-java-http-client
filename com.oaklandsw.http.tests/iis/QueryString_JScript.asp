...
<HTML>
    ...
    <BODY BGCOLOR="WHITE" TOPMARGIN="10" LEFTMARGIN="10">
		...
		name="count";value="<% Response.Write(Request.QueryString("count"))%>" <BR>
		name="fname";value="<% Response.Write(Request.QueryString("fname"))%>" <BR>
		name="lname";value="<% Response.Write(Request.QueryString("lname"))%>"
