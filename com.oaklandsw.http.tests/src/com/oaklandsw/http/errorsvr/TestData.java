...
public class TestData extends HttpTestBase {
    ...
    public HttpURLConnection testDataCloseBase(String serverArgs)
        throws Exception {
    ...
    public void testDataCloseNoCL() throws Exception {
        testDataCloseBase("?error=none" + "&close=true" +
    ...
    public void testData10CloseNoCL() throws Exception {
        testDataCloseBase("?error=none" + "&version=1.0" + "&close=true" +
            "&noContentLength=true");
    }

    public void testData10NoCL() throws Exception {
        testDataCloseBase("?error=none" + "&version=1.0" +
            "&noContentLength=true");
    }
    ...
    public void testData10KeepAliveNoCL() throws Exception {
        ...
        String serverArgs = "?error=none" + "&version=1.0" + "&keepAlive=true" +
            "&noContentLength=true";
    ...
    public void testData10KeepAliveCL() throws Exception {
        HttpURLConnection urlCon = testDataCloseBase("?error=none" +
                "&version=1.0" + "&keepAlive=true");
        urlCon.disconnect();
        checkNoTotalConns(urlCon.getURL());
    }

    public void testSpaceCL() throws Exception {
        URL url = new URL(_errorUrl + "?error=none" +
                "&spaceContentLength=true" + _errorDebug);
