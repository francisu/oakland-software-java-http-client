...
public class ErrorServer extends Thread {
    public static final int PORT_NUMBER = HttpTestEnv.ERRORSVR_PORT;
    ...
    private boolean simulateError() throws IOException {
        ...
        if (_errorType.equalsIgnoreCase("none")) {
            ...
            try {
                ...
                println();
                println("Here is some explanatory text about the " + respCode +
                    " error.");
    ...
    public void handleRequest() throws Exception {
        ...
        while (!closeConnection) {
            ...
            if (_errorLoc.equalsIgnoreCase("during-headers") &&
                    simulateError()) {
                return;
            }
