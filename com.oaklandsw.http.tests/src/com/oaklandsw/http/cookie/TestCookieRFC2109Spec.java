/*
 * $Header:
 * /home/jerenkrantz/tmp/commons/commons-convert/cvs/home/cvs/jakarta-commons//httpclient/src/test/org/apache/commons/httpclient/cookie/TestCookieRFC2109Spec.java,v
 * 1.3 2004/06/05 16:49:20 olegk Exp $ $Revision: 290666 $ $Date: 2005-09-21
 * 02:30:56 -0700 (Wed, 21 Sep 2005) $
 * ====================================================================
 *
...
public class TestCookieRFC2109Spec extends TestCookieBase {
    ...
    public void testParseAttributeInvalidVersion() throws Exception {
        ...
        try {
            Cookie cookie = new Cookie();
            cookiespec.parseAttribute(new NameValuePair("version", "nonsense"),
                cookie);
            fail("MalformedCookieException must have been thrown");
        } catch (MalformedCookieException expected) {
        }
    ...
    public void testParseVersion() throws Exception {
        String header = "cookie-name=cookie-value; version=1";
    ...
    public void testParseDomainEqualsHost() throws Exception {
        String header = "cookie-name=cookie-value; domain=www.b.com; version=1";

        CookieSpec cookiespec = new RFC2109Spec();
        Cookie[] parsed = cookieParse(cookiespec, "www.b.com", 80, "/", false,
                header);
    ...
    public void testParseWithIllegalDomain1() throws Exception {
        String header = "cookie-name=cookie-value; domain=a.b.com; version=1";
    ...
    public void testParseWithIllegalDomain2() throws Exception {
        String header = "cookie-name=cookie-value; domain=.com; version=1";
    ...
    public void testParseWithIllegalDomain4() throws Exception {
        String header = "cookie-name=cookie-value; domain=.c.com; version=1";
    ...
    /**
     * Tests if that invalid second domain level cookie gets rejected in the
     * strict mode, but gets accepted in the browser compatibility mode.
     */
    ...
    public void testParseWithWrongPath() throws Exception {
        String header = "cookie-name=cookie-value; domain=127.0.0.1; path=/not/just/root";
     ...
     * without domain where domain attribute does not match the host of origin
     */
    public void testInvalidDomainWithSimpleHostName() throws Exception {
        CookieSpec cookiespec = new RFC2109Spec();
        String header = "name=\"value\"; version=\"1\"; path=\"/\"; domain=\".mydomain.com\"";
        ...
        header = "name=\"value\"; version=\"1\"; path=\"/\"; domain=\"host1\"";
    ...
    public void testRFC2109CookieFormatting() throws Exception {
        ...
        assertEquals(s1,
            "$Version=\"1\"; name=\"value\"; $Path=\"/\"; $Domain=\".mydomain.com\"");

        header = "name=value; path=/; domain=.mydomain.com";
        cookies = cookiespec.parse("myhost.mydomain.com", 80, "/", false, header);
        cookiespec.validate("myhost.mydomain.com", 80, "/", false, cookies[0]);

        String s2 = cookiespec.formatCookie(cookies[0]);
        assertEquals(s2,
            "$Version=0; name=value; $Path=/; $Domain=.mydomain.com");
    }
    ...
    public void testRFC2109CookiesFormatting() throws Exception {
        ...
        Cookie[] cookies = cookieParse(cookiespec, "myhost.mydomain.com", 80,
                "/", false, header);
        ...
        header = "name1=value1; version=1; path=/; domain=.mydomain.com, " +
            "name2=\"value2\"; version=\"1\"; path=\"/\"; domain=\".mydomain.com\"";
        cookies = cookieParse(cookiespec, "myhost.mydomain.com", 80, "/",
                false, header);
        assertNotNull(cookies);
        assertEquals(2, cookies.length);
