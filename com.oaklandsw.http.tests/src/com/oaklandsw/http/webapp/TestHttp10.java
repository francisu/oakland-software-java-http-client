...
public class TestHttp10 extends TestWebappBase {
    ...
    public void test10KeepAliveHeader() throws Exception {
        ...
        if (urlCon.getConnectionProxyHost() != null) {
            ...
            assertFalse(checkReplyNoAssert(getReply(urlCon),
                    "name=\"" + conName + "\";value=\"keep-alive\"<br>"));
        } else {
            conName = "connection";
            checkReply(urlCon,
                "name=\"" + conName + "\";value=\"keep-alive\"<br>");
    ...
    public void test10ProxyKeepAlive() throws Exception {
        ...
        HttpURLConnection urlCon = (com.oaklandsw.http.HttpURLConnection) url.openConnection();
        urlCon.getResponseCode();
